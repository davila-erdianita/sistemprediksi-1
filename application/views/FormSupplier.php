...
<div class="col-md-10 p-5 pt-2 ml-auto" style="background-color: white;">
	...
	<div class="card" style="box-shadow: 0 3px 20px rgba(0,0,0,0.2);">
	  <div class="card-body">		
	    <h3><i class="fa-solid fa-gauge mr-2"></i>TAMBAH DATA SUPPLIER</h3><hr>
                    <form action="<?php echo base_url()."Supplier/insert_data";?>" method="POST">
                      ...
                      <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="masukkan alamat supplier" name="alamat_supplier"> 
                            <small><?php echo form_error('alamat_supplier');?></small>
                      </div>
                      <!-- <div class="form-group">
                            <label for="" class="form-label">Telephone</label>
                            <input type="text" class="form-control"  placeholder="masukkan no telephone supplier" name="telp"> 
