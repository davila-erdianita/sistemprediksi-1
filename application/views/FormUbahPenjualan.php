...
<div class="col-md-10 p-5 pt-2 ml-auto" style="background-color: white;">
	...
	<div class="card" style="box-shadow: 0 3px 20px rgba(0,0,0,0.2);">
	  <div class="card-body">		
	    <h3><i class="fa-solid fa-gauge mr-2"></i>UBAH DATA PENJUALAN</h3><hr>
         <?php
                foreach ($penjualan as $data) {
            ?> 
          <form action="<?php echo base_url()."Penjualan/update_data";?>" method="POST">
          	<input type="hidden" class="form-control" name="id_penjualan" id="id_penjualan" value="<?php echo $data['id_penjualan']?>">
          	<input type="hidden" class="form-control" name="id_detail" id="id_detail" value="<?php echo $data['id_detail']?>">
                      ...
                      <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="masukkan jumlah penjualan" name="jml_penjualan" value="<?php echo $data['jml_penjualan'];?>"> 
                            <small><?php echo form_error('jml_penjualan');?></small>
                      </div>
                      <div class="form-group">
                            <label for="" class="form-label">Tanggal Pemnjualan</label>
                            <input type="text" class="form-control"  placeholder="masukkan tanggal penjualan" name="tgl_penjualan" id="datepicker" value="<?php echo $data['tgl_penjualan'];?>"> 
