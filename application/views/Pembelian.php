...
<div class="col-md-10 p-5 pt-2 ml-auto" style="background-color: white;">
	<div class="card">
	  <div class="card-body">		
	    <h3><i class="fa-solid fa-gauge mr-2"></i> DATA PEMBELIAN</h3><hr>
	    <div class="row pt-2">
                <?php if($this->session->flashdata('status_pembelian')){?>
                            <div class="alert alert-success">
                                <?= $this->session->flashdata('status_pembelian')?>
                            </div>
                        <?php }elseif($this->session->flashdata('gagal_pembelian')){?>
                          <div class="alert alert-danger">
                                <?= $this->session->flashdata('gagal_pembelian')?>
                            </div>
                        <?php }?> 
    	</div>
	    <div class="row">
	    <div class="col-md-7 mt-2">
	    	<a href="<?php echo base_url();?>Pembelian/FormPembelian" class="btn btn-outline-primary btn-sm mb-3">Tambah Data</a>
		</div>
		<!-- <div class="col pl-5">
			...
			<div class="col">
				<div class="table-responsive">
					  <table class="table" id="datatables">
						  ...
						  <tbody><?php $i=1; foreach ($all_pembelian as $data) : ?>
						    <tr>
						      <td><?= $i++;?></td>
						      ...
						      <td><a href="<?php echo base_url()."Pembelian/delete_data/".$data['id_pembelian'];?>" id="del" class="btn btn-sm btn-outline-danger"><i class="fas fa-trash-alt"></i></a>
                                  <a href="<?php echo base_url()."Pembelian/UpdateForm/".$data['id_pembelian'];?>" id="edit" class="btn btn-sm btn-outline-info"><i class="fas fa-edit"></i></a>
                              </td>
						    </tr>
						<?php endforeach; ?>
						  </tbody>
