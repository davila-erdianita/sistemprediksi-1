...
<div class="col-md-10 p-5 pt-2 ml-auto" style="background-color: white;">
	...
	<div class="card" style="box-shadow: 0 3px 20px rgba(0,0,0,0.2);">
	  <div class="card-body">
	    <h3><i class="fa-solid fa-gauge mr-2"></i>TAMBAH DATA PEMBELIAN</h3><hr>
                    <form action="<?php echo base_url()."Pembelian/insert_data";?>" method="POST">
                      ...
                      <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="masukkan jumlah pembelian" name="jml_pembelian"> 
                            <small><?php echo form_error('jml_pembelian');?></small>
                      </div>
                      <div class="form-group">
                            <label for="" class="form-label">Tanggal Pembelian</label>
                            <input type="text" class="form-control"  placeholder="masukkan tanggal pembelian" name="tgl_pembelian" id="datepicker"> 
