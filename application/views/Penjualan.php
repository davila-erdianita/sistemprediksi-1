...
<div class="col-md-10 p-5 pt-2 ml-auto" style="background-color: white;">
	<div class="card">
	  <div class="card-body">		
	    <h3><i class="fa-solid fa-gauge mr-2"></i> DATA PENJUALAN</h3><hr>
	    <div class="row pt-2">
                <?php if($this->session->flashdata('status_penjualan')){?>
                            <div class="alert alert-success">
                                <?= $this->session->flashdata('status_penjualan')?>
                            </div>
                        <?php }elseif($this->session->flashdata('gagal_penjualan')){?>
                          <div class="alert alert-danger">
                                <?= $this->session->flashdata('gagal_penjualan')?>
                            </div>
                        <?php }?> 
    	</div>
	    <div class="row">
	    <div class="col">
	    	<a href="<?php echo base_url();?>Prediksi" class="btn btn-outline-success btn-sm mb-3">Prediksi Data</a>
	    	<a href="<?php echo base_url();?>Penjualan/FormPenjualan" class="btn btn-outline-primary btn-sm mb-3">Tambah Data</a>
		</div>
<!-- 		<div class="col pl-5">
			...
			<div class="col">
				<div class="table-responsive">
					  <table class="table" id="datatables">
						  ...
						  <tbody><?php $i=1; foreach ($all_penjualan as $data) : ?>
						    <tr>
						      <td><?= $i++;?></td>
						     <!--  <td><?= $data['id_detail'];?></td>
						      ...
						      <td><a href="<?php echo base_url()."Penjualan/delete_data/".$data['id_detail'];?>" id="del" class="btn btn-sm btn-outline-danger"><i class="fas fa-trash-alt"></i></a>
                                  <a href="<?php echo base_url()."Penjualan/UpdateForm/".$data['id_detail'];?>" id="edit" class="btn btn-sm btn-outline-info"><i class="fas fa-edit"></i></a>
                              </td>
						    </tr>
						<?php endforeach; ?>
						  </tbody>
