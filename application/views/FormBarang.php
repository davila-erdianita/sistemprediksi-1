...
<div class="col-md-10 p-5 pt-2 ml-auto" style="background-color: white;">
	...
	<div class="card" style="box-shadow: 0 3px 20px rgba(0,0,0,0.2);">
	  <div class="card-body">	
	    <h3><i class="fa-solid fa-gauge mr-2"></i>TAMBAH DATA BARANG</h3><hr>
                    <form action="<?php echo base_url()."Barang/insert_data";?>" method="POST">
                     ...
                     <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="masukkan biaya penyimpanan" name="biaya_penyimpanan"> 
                            <small><?php echo form_error('biaya_penyimpanan');?></small>
                      </div>
                      <div class="form-group">
                            <label for="" class="form-label">Biaya Pemesanan</label>
                            <input type="text" class="form-control"  placeholder="masukkan biaya pemesanan" name="biaya_pemesanan"> 
                            <small><?php echo form_error('biaya_pemesanan');?></small>
                      </div>
                      <div class="form-group">
                            <label for="" class="form-label">Harga Pembelian</label>
                            <input type="text" class="form-control"  placeholder="masukkan harga pembelian" name="harga_pembelian"> 
                      ...
                      <div class="form-group">
                            ...
                            <input type="text" class="form-control"  placeholder="masukkan jumlah persediaan" name="jml_persediaan"> 
